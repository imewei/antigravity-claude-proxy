...
window.translations.tr = {
    ...
    modelMappingHint:
        "Sunucu tarafı model yönlendirme. Claude Code kullanıcıları: istemci tarafı kurulumu için 'Claude CLI' sekmesine bakın.",
    // Settings - Claude
    ...
    environment: 'Ortam',
    serverReadOnly:
        'Ayarlar config.json üzerinden yönetilir. Değişiklikleri uygulamak için sunucuyu yeniden başlatın.',
    ...
    connectGoogleDesc:
        'API kota limitinizi artırmak için bir Google Workspace hesabı bağlayın. Bu hesap, Claude isteklerini Antigravity üzerinden vekil sunucu olarak kullanmak için kullanılacaktır.',
    ...
    confirmRestoreMessage:
        "Claude CLI'yı varsayılan ayarlara geri yüklemek istediğinizden emin misiniz? Bu işlem proxy yapılandırmasını kaldıracaktır.",
    ...
    maxWaitDesc:
        'Yapışkan bir hesabın değiştirmeden önce sıfırlanması için beklenecek maksimum süre.',
    ...
    rateLimitDedupWindowDesc:
        'Birden fazla istek aynı anda hız sınırına ulaştığında yeniden deneme fırtınasını önler.',
    ...
    capacityRetryDelayDesc:
        'Model kapasitesi tükendiğinde (kota değil) yeniden denemeden önceki gecikme.',
    maxCapacityRetries: 'Maks. Kapasite Yeniden Denemesi',
    maxCapacityRetriesDesc:
        'Hesap değiştirmeden önce kapasite tükenmesi için maksimum yeniden deneme.',
    saveConfigServer: 'Yapılandırmayı Kaydet',
    serverRestartAlert:
        'Değişiklikler {path} konumuna kaydedildi. Bazı ayarları uygulamak için sunucuyu yeniden başlatın.',
    ...
    noAccountsDesc:
        'OAuth üzerinden bir Google hesabı ekleyerek veya kimlik bilgilerini içe aktarmak için CLI komutunu kullanarak başlayın.',
    addFirstAccount: 'İlk Hesabınızı Ekleyin',
    noSearchResults: 'Aramanızla eşleşen hesap yok',
    clearSearch: 'Aramayı Temizle',
    disabledAccountsNote:
        '<strong>Devre dışı bırakılan hesaplar</strong> istek yönlendirmesi için kullanılmayacak ancak yapılandırmada kalacaktır. Pano istatistikleri yalnızca etkin hesapları içerir.',
    dangerousOperation: '⚠️ Tehlikeli İşlem',
    confirmDeletePrompt: 'Hesabı silmek istediğinizden emin misiniz',
    deleteWarning:
        '⚠️ Bu işlem geri alınamaz. Tüm yapılandırma ve geçmiş kayıtları kalıcı olarak silinecektir.',
    // OAuth progress
    oauthWaiting: 'OAuth yetkilendirmesi bekleniyor...',
    oauthWaitingDesc:
        'Lütfen açılır pencerede kimlik doğrulamasını tamamlayın. Bu işlem 2 dakikaya kadar sürebilir.',
    ...
    mcpCliDesc:
        'Daha az bağlam tüketimi ile güvenilir araç kullanımı için deneysel MCP entegrasyonunu etkinleştirir.',
