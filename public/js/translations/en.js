...
window.translations.en = {
    ...
    unsavedChangesMessage:
        "Your current configuration doesn't match any saved preset. If you switch, your current unsaved settings will be lost.",
    ...
    maxWaitDesc:
        'If all accounts are rate-limited longer than this, error immediately instead of waiting.',
    ...
    rateLimitDedupWindowDesc:
        'Prevents concurrent retry storms when multiple requests hit rate limits simultaneously.',
    maxConsecutiveFailures: 'Max Consecutive Failures',
    maxConsecutiveFailuresDesc:
        'Number of consecutive failures before applying extended cooldown to an account.',
