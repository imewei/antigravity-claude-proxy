...
window.translations.id = {
    ...
    oauthInProgress:
        'Proses OAuth sedang berjalan. Silakan selesaikan autentikasi di jendela popup...',
    family: 'Jenis',
    model: 'Model',
    activeSuffix: 'Aktif',
    ...
    modelMappingHint:
        "Routing model di sisi server. Pengguna Claude Code: lihat tab 'Claude CLI' untuk pengaturan di sisi klien.",
    ...
    unsavedChangesMessage:
        'Konfigurasi saat ini tidak cocok dengan preset tersimpan. Jika beralih, perubahan akan hilang.',
    ...
    connectGoogleDesc:
        'Hubungkan akun Google Workspace untuk meningkatkan kuota API. Akun akan digunakan untuk meneruskan request Claude via Antigravity.',
    ...
    confirmRestoreMessage:
        'Yakin ingin mengembalikan Claude CLI ke pengaturan default? Konfigurasi proxy akan dihapus.',
    ...
    rateLimitDedupWindowDesc:
        'Mencegah badai retry ketika beberapa permintaan terkena rate limit bersamaan.',
    maxConsecutiveFailures: 'Maks. Kegagalan Berturut-turut',
    maxConsecutiveFailuresDesc:
        'Jumlah kegagalan berturut-turut sebelum menerapkan cooldown diperpanjang.',
    ...
    noAccountsDesc:
        'Mulai dengan menambahkan akun Google via OAuth, atau gunakan perintah CLI untuk import kredensial.',
    ...
    disabledAccountsNote:
        '<strong>Akun nonaktif</strong> tidak akan digunakan untuk routing tapi tetap tersimpan di konfigurasi. Statistik dashboard hanya mencakup akun aktif.',
    dangerousOperation: '⚠️ Operasi Berbahaya',
    confirmDeletePrompt: 'Yakin ingin menghapus akun',
    deleteWarning:
        '⚠️ Tindakan ini tidak bisa dibatalkan. Semua pengaturan dan riwayat akan dihapus permanen.',

    // OAuth progress
    oauthWaiting: 'Menunggu otorisasi OAuth...',
    oauthWaitingDesc:
        'Silakan selesaikan autentikasi di jendela popup. Proses ini bisa memakan waktu hingga 2 menit.',
    ...
    mcpCliDesc:
        'Aktifkan integrasi MCP eksperimental untuk penggunaan tool yang lebih stabil dengan konsumsi konteks lebih rendah.',
    ...
    strategyStickyDesc:
        'Tetap di akun yang sama hingga terkena rate limit. Terbaik untuk cache prompt.',
